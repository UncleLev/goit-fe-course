...
const fullviewImg = `<img src=${galleryItems[0].fullview} alt="${galleryItems[0].alt}">`;

fullview.innerHTML = fullviewImg;

const Allpreview = galleryItems.reduce((acc, el) => {
    return acc + `<li><img src=${el.preview} data-fullview=${el.fullview} alt="${el.alt}"></li>`
}, []);
